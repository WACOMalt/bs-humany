...
export const MUSCLE_VIA_POINTS: readonly MuscleViaPoint[] = [
  ...
  },
  {
    ...
    local: [0.0105181, -0.0208647, 0.0220816],
  },
  {
    ...
    local: [0.0201438, -0.0414169, 0.023547],
  },
  {
...
export const VIA_PATH_DIRECTION: Readonly<Record<string, 'forward' | 'reversed'>> = {
  ...
  pronator_teres_r: 'forward',
  pronator_teres_l: 'forward',
  pronator_quadratus_r: 'reversed',
  pronator_quadratus_l: 'reversed',
  supinator_r: 'reversed',
  supinator_l: 'reversed',
  anconeus_r: 'forward',
  anconeus_l: 'forward',
  flexor_carpi_radialis_r: 'forward',
  flexor_carpi_radialis_l: 'forward',
  flexor_carpi_ulnaris_r: 'forward',
  flexor_carpi_ulnaris_l: 'forward',
  extensor_carpi_radialis_longus_r: 'forward',
  extensor_carpi_radialis_longus_l: 'forward',
  extensor_carpi_radialis_brevis_r: 'forward',
  extensor_carpi_radialis_brevis_l: 'forward',
