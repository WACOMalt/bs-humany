...
import { type Quat, type Vec3, multiplyQuat, rotate, vec3 } from '@bs-humany/frames';
...
import type { Scenario, ScenarioApi } from '@bs-humany/scenarios';
...
/** Rotate the whole rest pose about the mid-hip point and lift it to the scenario clearance. */
export function placeArticulation(
  ...
  // Lowest origin, minus a margin for the proxy around it, sits at the clearance.
